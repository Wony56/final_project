  ...
  <div class="user-detail">
    ...
    <div class="human-body">
        <div class="muscle-groups">
          ...
          <input type="checkbox" class="deltoids muscles-helper" id="deltoids"> <label for="deltoids">어깨</label>
          <input type="checkbox" class="forearms muscles-helper" id="forearms"> <label for="forearms">손목</label>
          <input type="checkbox" class="triceps muscles-helper" id="triceps"> <label for="triceps">팔</label>
          <input type="checkbox" class="trapezius muscles-helper" id="trapezius"> <label for="trapezius">등</label>
          <input type="checkbox" class="lats muscles-helper" id="lats"> <label for="lats">허리</label>
          <input type="checkbox" class="abs muscles-helper" id="abs"> <label for="abs">복근</label>
          <input type="checkbox" class="pectorals muscles-helper" id="pectorals"> <label for="pectorals">가슴</label>
          <input type="checkbox" class="calves muscles-helper" id="calves"> <label for="calves">종아리</label>
          <input type="checkbox" class="hamstrings muscles-helper" id="hamstrings"> <label for="hamstrings">허벅지</label>
          <input type="checkbox" class="glutes muscles-helper" id="glutes"> <label for="glutes">엉덩이</label>
<div style="clear : both"></div>
        <svg viewBox="0 0 176 207" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
...
<table>
  <tr>
    <th>NAME</th>
    <td><input type="text" id="username" :placeholder="body.name"></td>
  </tr>
  <tr>
    <th>AGE</th>
    <td><input type="text" id="userage" :placeholder="body.age"></td>
  </tr>
  <tr>
    <th>JOB</th>
    <td><input type="text" id="userjob" :placeholder="body.job"></td>
  </tr>
</table>

    </div>
<div class="buttons">
    <v-btn class="ma-2" tile outlined color="success" style="color:green" @click="Edit">
...
.muscle-groups {
  ...
  overflow: hidden;
  border-top: .75rem solid $color-1;
  h1 {
...
export default{
  ...
  mounted(){
    ...
    for (var i=0; i<this.all_part.length; i++) {
        ...
        for (var j=0; j<this.body.part.length; j++) {
          if(this.body.part[j]===this.all_part[i]){
            //console.log(this.eng_part[i]+"!!")//eslint-disable-line no-console
            document.getElementById(this.eng_part[i]).checked = true
          }
        }
    }
  },
